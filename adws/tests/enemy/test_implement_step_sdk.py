"""Enemy Unit Tests for implement_step SDK call.
...
The EUT validates the SDK round-trip with a GREEN phase
...
def test_eut_implement_step_sdk_round_trip() -> None:
    """EUT: GREEN phase SDK round-trip with real API.
